...
class PatientTests: XCTestCase, RealmPersistenceTesting {    
    ...
    func inflateFrom(data: Data) throws -> FireKit.Patient {
        // print("Inflating FireKit.Patient from data: \(data)")
    ...
    func testPatient1Copying() {
        do {
            ...
            XCTAssertTrue(false, "Must copy and test Patient successfully, but threw: \(error)")
        }
    }

    func testPatient1Populatability() {
        do {
            let instance = try runPatient1()
            let copy = FireKit.Patient()
    ...
    func testPatientRealm1(_ instance: FireKit.Patient) {
        ...
        let existing = realm.object(ofType: FireKit.Patient.self, forPrimaryKey: newInst.pk)!
    ...
    func testPatient2Populatability() {
        do {
            let instance = try runPatient2()
            let copy = FireKit.Patient()
            copy.populate(from: instance)
    ...
    func testPatient3Populatability() {
        do {
            let instance = try runPatient3()
            let copy = FireKit.Patient()
            copy.populate(from: instance)
    ...
    func testPatient4Populatability() {
        do {
            let instance = try runPatient4()
            let copy = FireKit.Patient()
            copy.populate(from: instance)
    ...
    func testPatient5Populatability() {
        do {
            let instance = try runPatient5()
            let copy = FireKit.Patient()
            copy.populate(from: instance)
    ...
    func testPatient6Populatability() {
        do {
            let instance = try runPatient6()
            let copy = FireKit.Patient()
            copy.populate(from: instance)
    ...
    func testPatient7Populatability() {
        do {
            let instance = try runPatient7()
            let copy = FireKit.Patient()
            copy.populate(from: instance)
    ...
    func testPatient8Populatability() {
        do {
            let instance = try runPatient8()
            let copy = FireKit.Patient()
            copy.populate(from: instance)
    ...
    func testPatient9Populatability() {
        do {
            let instance = try runPatient9()
            let copy = FireKit.Patient()
            copy.populate(from: instance)
    ...
    func testPatient10Populatability() {
        do {
            let instance = try runPatient10()
            let copy = FireKit.Patient()
            copy.populate(from: instance)
