...
class PatientTests: XCTestCase, RealmPersistenceTesting {    
	...
	func instantiateFrom(filename: String) throws -> FireKit.Patient {
		return instantiateFrom(json: try readJSONFile(filename))
	}
	
	func instantiateFrom(json: FHIRJSON) -> FireKit.Patient {
	...
	func testPatientRealm1(instance: FireKit.Patient) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runPatient1(realm.objects(FireKit.Patient.self).first!.asJSON())
	...
	func testPatientRealm2(instance: FireKit.Patient) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runPatient2(realm.objects(FireKit.Patient.self).first!.asJSON())
	...
	func testPatientRealm3(instance: FireKit.Patient) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runPatient3(realm.objects(FireKit.Patient.self).first!.asJSON())
	...
	func testPatientRealm4(instance: FireKit.Patient) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runPatient4(realm.objects(FireKit.Patient.self).first!.asJSON())
	...
	func testPatientRealm5(instance: FireKit.Patient) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runPatient5(realm.objects(FireKit.Patient.self).first!.asJSON())
	...
	func testPatientRealm6(instance: FireKit.Patient) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runPatient6(realm.objects(FireKit.Patient.self).first!.asJSON())
	...
	func testPatientRealm7(instance: FireKit.Patient) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runPatient7(realm.objects(FireKit.Patient.self).first!.asJSON())
	...
	func testPatientRealm8(instance: FireKit.Patient) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runPatient8(realm.objects(FireKit.Patient.self).first!.asJSON())
	...
	func testPatientRealm9(instance: FireKit.Patient) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runPatient9(realm.objects(FireKit.Patient.self).first!.asJSON())
	...
	func testPatientRealm10(instance: FireKit.Patient) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runPatient10(realm.objects(FireKit.Patient.self).first!.asJSON())
