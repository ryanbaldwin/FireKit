...
class ConditionTests: XCTestCase, RealmPersistenceTesting {    
    ...
    func testCondition1Copying() {
        do {
            ...
            XCTAssertTrue(false, "Must copy and test Condition successfully, but threw: \(error)")
        }
    }

    func testCondition1Populatability() {
        do {
            let instance = try runCondition1()
            let copy = FireKit.Condition()
    ...
    func testConditionRealm1(_ instance: FireKit.Condition) {
        ...
        let existing = realm.object(ofType: FireKit.Condition.self, forPrimaryKey: newInst.pk)!
    ...
    func testCondition2Populatability() {
        do {
            let instance = try runCondition2()
            let copy = FireKit.Condition()
            copy.populate(from: instance)
    ...
    func testCondition3Populatability() {
        do {
            let instance = try runCondition3()
            let copy = FireKit.Condition()
            copy.populate(from: instance)
    ...
    func testCondition4Populatability() {
        do {
            let instance = try runCondition4()
            let copy = FireKit.Condition()
            copy.populate(from: instance)
    ...
    func testCondition5Populatability() {
        do {
            let instance = try runCondition5()
            let copy = FireKit.Condition()
            copy.populate(from: instance)
    ...
    func testCondition6Populatability() {
        do {
            let instance = try runCondition6()
            let copy = FireKit.Condition()
            copy.populate(from: instance)
    ...
    func testCondition7Populatability() {
        do {
            let instance = try runCondition7()
            let copy = FireKit.Condition()
            copy.populate(from: instance)
    ...
    func testCondition8Populatability() {
        do {
            let instance = try runCondition8()
            let copy = FireKit.Condition()
            copy.populate(from: instance)
    ...
    func testCondition9Populatability() {
        do {
            let instance = try runCondition9()
            let copy = FireKit.Condition()
            copy.populate(from: instance)
    ...
    func testCondition10Populatability() {
        do {
            let instance = try runCondition10()
            let copy = FireKit.Condition()
            copy.populate(from: instance)
