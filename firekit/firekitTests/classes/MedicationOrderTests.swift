...
class MedicationOrderTests: XCTestCase, RealmPersistenceTesting {    
	...
	func instantiateFrom(filename: String) throws -> FireKit.MedicationOrder {
		return instantiateFrom(json: try readJSONFile(filename))
	}
	
	func instantiateFrom(json: FHIRJSON) -> FireKit.MedicationOrder {
	...
	func testMedicationOrderRealm1(instance: FireKit.MedicationOrder) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runMedicationOrder1(realm.objects(FireKit.MedicationOrder.self).first!.asJSON())
	...
	func testMedicationOrderRealm2(instance: FireKit.MedicationOrder) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runMedicationOrder2(realm.objects(FireKit.MedicationOrder.self).first!.asJSON())
	...
	func testMedicationOrderRealm3(instance: FireKit.MedicationOrder) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runMedicationOrder3(realm.objects(FireKit.MedicationOrder.self).first!.asJSON())
	...
	func testMedicationOrderRealm4(instance: FireKit.MedicationOrder) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runMedicationOrder4(realm.objects(FireKit.MedicationOrder.self).first!.asJSON())
	...
	func testMedicationOrderRealm5(instance: FireKit.MedicationOrder) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runMedicationOrder5(realm.objects(FireKit.MedicationOrder.self).first!.asJSON())
	...
	func testMedicationOrderRealm6(instance: FireKit.MedicationOrder) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runMedicationOrder6(realm.objects(FireKit.MedicationOrder.self).first!.asJSON())
	...
	func testMedicationOrderRealm7(instance: FireKit.MedicationOrder) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runMedicationOrder7(realm.objects(FireKit.MedicationOrder.self).first!.asJSON())
	...
	func testMedicationOrderRealm8(instance: FireKit.MedicationOrder) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runMedicationOrder8(realm.objects(FireKit.MedicationOrder.self).first!.asJSON())
