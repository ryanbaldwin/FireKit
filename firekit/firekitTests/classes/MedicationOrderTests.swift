...
class MedicationOrderTests: XCTestCase, RealmPersistenceTesting {    
    ...
    func inflateFrom(data: Data) throws -> FireKit.MedicationOrder {
        // print("Inflating FireKit.MedicationOrder from data: \(data)")
    ...
    func testMedicationOrder1Copying() {
        do {
            ...
            XCTAssertTrue(false, "Must copy and test MedicationOrder successfully, but threw: \(error)")
        }
    }

    func testMedicationOrder1Populatability() {
        do {
            let instance = try runMedicationOrder1()
            let copy = FireKit.MedicationOrder()
            copy.populate(from: instance)
            XCTAssertNotEqual(instance.pk, copy.pk)
            try runMedicationOrder1(try JSONEncoder().encode(copy))
        }
        catch let error {
            XCTAssertTrue(false, "Must populate an test MedicationOrder successfully, but threw: \(error)")
        }
    }

    func testMedicationOrder1NillingPopulatability() {
        do {
            let instance = try runMedicationOrder1()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.MedicationOrder()) }
        } catch let error {
            XCTAssertTrue(false, "Must populate a test MedicationOrder successfully, but threw: \(error)")
        }
    }
    ...
    func testMedicationOrderRealm1(_ instance: FireKit.MedicationOrder) {
        ...
        let existing = realm.object(ofType: FireKit.MedicationOrder.self, forPrimaryKey: newInst.pk)!
    ...
    func testMedicationOrder2Copying() {
        do {
    ...
    func testMedicationOrder2Populatability() {
        do {
            let instance = try runMedicationOrder2()
            let copy = FireKit.MedicationOrder()
            copy.populate(from: instance)
    ...
    func testMedicationOrder2NillingPopulatability() {
        do {
            let instance = try runMedicationOrder2()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.MedicationOrder()) }
    ...
    func testMedicationOrder3Copying() {
        do {
    ...
    func testMedicationOrder3Populatability() {
        do {
            let instance = try runMedicationOrder3()
            let copy = FireKit.MedicationOrder()
            copy.populate(from: instance)
    ...
    func testMedicationOrder3NillingPopulatability() {
        do {
            let instance = try runMedicationOrder3()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.MedicationOrder()) }
    ...
    func testMedicationOrder4Copying() {
        do {
    ...
    func testMedicationOrder4Populatability() {
        do {
            let instance = try runMedicationOrder4()
            let copy = FireKit.MedicationOrder()
            copy.populate(from: instance)
    ...
    func testMedicationOrder4NillingPopulatability() {
        do {
            let instance = try runMedicationOrder4()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.MedicationOrder()) }
    ...
    func testMedicationOrder5Copying() {
        do {
    ...
    func testMedicationOrder5Populatability() {
        do {
            let instance = try runMedicationOrder5()
            let copy = FireKit.MedicationOrder()
            copy.populate(from: instance)
    ...
    func testMedicationOrder5NillingPopulatability() {
        do {
            let instance = try runMedicationOrder5()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.MedicationOrder()) }
    ...
    func testMedicationOrder6Copying() {
        do {
    ...
    func testMedicationOrder6Populatability() {
        do {
            let instance = try runMedicationOrder6()
            let copy = FireKit.MedicationOrder()
            copy.populate(from: instance)
    ...
    func testMedicationOrder6NillingPopulatability() {
        do {
            let instance = try runMedicationOrder6()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.MedicationOrder()) }
    ...
    func testMedicationOrder7Copying() {
        do {
    ...
    func testMedicationOrder7Populatability() {
        do {
            let instance = try runMedicationOrder7()
            let copy = FireKit.MedicationOrder()
            copy.populate(from: instance)
    ...
    func testMedicationOrder7NillingPopulatability() {
        do {
            let instance = try runMedicationOrder7()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.MedicationOrder()) }
    ...
    func testMedicationOrder8Copying() {
        do {
    ...
    func testMedicationOrder8Populatability() {
        do {
            let instance = try runMedicationOrder8()
            let copy = FireKit.MedicationOrder()
            copy.populate(from: instance)
    ...
    func testMedicationOrder8NillingPopulatability() {
        do {
            let instance = try runMedicationOrder8()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.MedicationOrder()) }
