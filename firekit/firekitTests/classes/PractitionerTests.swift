...
class PractitionerTests: XCTestCase, RealmPersistenceTesting {    
    ...
    func inflateFrom(data: Data) throws -> FireKit.Practitioner {
        // print("Inflating FireKit.Practitioner from data: \(data)")
    ...
    func testPractitioner1Copying() {
        do {
            ...
            XCTAssertTrue(false, "Must copy and test Practitioner successfully, but threw: \(error)")
        }
    }

    func testPractitioner1Populatability() {
        do {
            let instance = try runPractitioner1()
            let copy = FireKit.Practitioner()
    ...
    func testPractitionerRealm1(_ instance: FireKit.Practitioner) {
        ...
        let existing = realm.object(ofType: FireKit.Practitioner.self, forPrimaryKey: newInst.pk)!
    ...
    func testPractitioner2Populatability() {
        do {
            let instance = try runPractitioner2()
            let copy = FireKit.Practitioner()
            copy.populate(from: instance)
    ...
    func testPractitioner3Populatability() {
        do {
            let instance = try runPractitioner3()
            let copy = FireKit.Practitioner()
            copy.populate(from: instance)
    ...
    func testPractitioner4Populatability() {
        do {
            let instance = try runPractitioner4()
            let copy = FireKit.Practitioner()
            copy.populate(from: instance)
    ...
    func testPractitioner5Populatability() {
        do {
            let instance = try runPractitioner5()
            let copy = FireKit.Practitioner()
            copy.populate(from: instance)
    ...
    func testPractitioner6Populatability() {
        do {
            let instance = try runPractitioner6()
            let copy = FireKit.Practitioner()
            copy.populate(from: instance)
    ...
    func testPractitioner7Populatability() {
        do {
            let instance = try runPractitioner7()
            let copy = FireKit.Practitioner()
            copy.populate(from: instance)
    ...
    func testPractitioner8Populatability() {
        do {
            let instance = try runPractitioner8()
            let copy = FireKit.Practitioner()
            copy.populate(from: instance)
    ...
    func testPractitioner9Populatability() {
        do {
            let instance = try runPractitioner9()
            let copy = FireKit.Practitioner()
            copy.populate(from: instance)
    ...
    func testPractitioner10Copying() {
        do {
    ...
    func testPractitioner10Populatability() {
        do {
            let instance = try runPractitioner10()
            let copy = FireKit.Practitioner()
            copy.populate(from: instance)
