...
class PractitionerTests: XCTestCase, RealmPersistenceTesting {    
	...
	func instantiateFrom(filename: String) throws -> FireKit.Practitioner {
		return instantiateFrom(json: try readJSONFile(filename))
	}
	
	func instantiateFrom(json: FHIRJSON) -> FireKit.Practitioner {
	...
	func testPractitionerRealm1(instance: FireKit.Practitioner) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runPractitioner1(realm.objects(FireKit.Practitioner.self).first!.asJSON())
	...
	func testPractitionerRealm2(instance: FireKit.Practitioner) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runPractitioner2(realm.objects(FireKit.Practitioner.self).first!.asJSON())
	...
	func testPractitionerRealm3(instance: FireKit.Practitioner) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runPractitioner3(realm.objects(FireKit.Practitioner.self).first!.asJSON())
	...
	func testPractitionerRealm4(instance: FireKit.Practitioner) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runPractitioner4(realm.objects(FireKit.Practitioner.self).first!.asJSON())
	...
	func testPractitionerRealm5(instance: FireKit.Practitioner) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runPractitioner5(realm.objects(FireKit.Practitioner.self).first!.asJSON())
	...
	func testPractitionerRealm6(instance: FireKit.Practitioner) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runPractitioner6(realm.objects(FireKit.Practitioner.self).first!.asJSON())
	...
	func testPractitionerRealm7(instance: FireKit.Practitioner) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runPractitioner7(realm.objects(FireKit.Practitioner.self).first!.asJSON())
	...
	func testPractitionerRealm8(instance: FireKit.Practitioner) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runPractitioner8(realm.objects(FireKit.Practitioner.self).first!.asJSON())
	...
	func testPractitionerRealm9(instance: FireKit.Practitioner) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runPractitioner9(realm.objects(FireKit.Practitioner.self).first!.asJSON())
	...
	func testPractitionerRealm10(instance: FireKit.Practitioner) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runPractitioner10(realm.objects(FireKit.Practitioner.self).first!.asJSON())
