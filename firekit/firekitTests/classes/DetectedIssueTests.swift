...
class DetectedIssueTests: XCTestCase, RealmPersistenceTesting {    
    ...
    func testDetectedIssue1NillingPopulatability() {
        do {
            let instance = try runDetectedIssue1()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.DetectedIssue()) }
        } catch let error {
            XCTAssertTrue(false, "Must populate a test DetectedIssue successfully, but threw: \(error)")
        }
    }
    ...
    func testDetectedIssueRealm1(_ instance: FireKit.DetectedIssue) {
        ...
        let existing = realm.object(ofType: FireKit.DetectedIssue.self, forPrimaryKey: newInst.pk)!
    ...
    func testDetectedIssue2NillingPopulatability() {
        do {
            let instance = try runDetectedIssue2()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.DetectedIssue()) }
    ...
    func testDetectedIssue3NillingPopulatability() {
        do {
            let instance = try runDetectedIssue3()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.DetectedIssue()) }
    ...
    func testDetectedIssue4NillingPopulatability() {
        do {
            let instance = try runDetectedIssue4()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.DetectedIssue()) }
