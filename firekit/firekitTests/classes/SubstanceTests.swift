...
class SubstanceTests: XCTestCase, RealmPersistenceTesting {    
    ...
    func testSubstance1NillingPopulatability() {
        do {
            let instance = try runSubstance1()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.Substance()) }
        } catch let error {
            XCTAssertTrue(false, "Must populate a test Substance successfully, but threw: \(error)")
        }
    }
    ...
    func testSubstance2NillingPopulatability() {
        do {
            let instance = try runSubstance2()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.Substance()) }
    ...
    func testSubstance3NillingPopulatability() {
        do {
            let instance = try runSubstance3()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.Substance()) }
    ...
    func testSubstance4NillingPopulatability() {
        do {
            let instance = try runSubstance4()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.Substance()) }
    ...
    func testSubstance5NillingPopulatability() {
        do {
            let instance = try runSubstance5()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.Substance()) }
    ...
    func testSubstance6NillingPopulatability() {
        do {
            let instance = try runSubstance6()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.Substance()) }
