...
class ObservationTests: XCTestCase, RealmPersistenceTesting {    
    ...
    func testObservation1Copying() {
        do {
            ...
            XCTAssertTrue(false, "Must copy and test Observation successfully, but threw: \(error)")
        }
    }

    func testObservation1Populatability() {
        do {
            let instance = try runObservation1()
            let copy = FireKit.Observation()
    ...
    func testObservationRealm1(_ instance: FireKit.Observation) {
        ...
        let existing = realm.object(ofType: FireKit.Observation.self, forPrimaryKey: newInst.pk)!
    ...
    func testObservation2Populatability() {
        do {
            let instance = try runObservation2()
            let copy = FireKit.Observation()
            copy.populate(from: instance)
    ...
    func testObservation3Populatability() {
        do {
            let instance = try runObservation3()
            let copy = FireKit.Observation()
            copy.populate(from: instance)
    ...
    func testObservation4Populatability() {
        do {
            let instance = try runObservation4()
            let copy = FireKit.Observation()
            copy.populate(from: instance)
    ...
    func testObservation5Populatability() {
        do {
            let instance = try runObservation5()
            let copy = FireKit.Observation()
            copy.populate(from: instance)
    ...
    func testObservation6Populatability() {
        do {
            let instance = try runObservation6()
            let copy = FireKit.Observation()
            copy.populate(from: instance)
    ...
    func testObservation7Populatability() {
        do {
            let instance = try runObservation7()
            let copy = FireKit.Observation()
            copy.populate(from: instance)
    ...
    func testObservation8Populatability() {
        do {
            let instance = try runObservation8()
            let copy = FireKit.Observation()
            copy.populate(from: instance)
    ...
    func testObservation9Populatability() {
        do {
            let instance = try runObservation9()
            let copy = FireKit.Observation()
            copy.populate(from: instance)
    ...
    func testObservation10Populatability() {
        do {
            let instance = try runObservation10()
            let copy = FireKit.Observation()
            copy.populate(from: instance)
