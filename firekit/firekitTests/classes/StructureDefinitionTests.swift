...
class StructureDefinitionTests: XCTestCase, RealmPersistenceTesting {    
    ...
    func testStructureDefinitionRealm1(_ instance: FireKit.StructureDefinition) {
        ...
        var existing = realm.object(ofType: FireKit.StructureDefinition.self, forPrimaryKey: newInst.pk)!
        // TODO: populated stuff
        // try! realm.write{ _ = existing.populate(from: instance.asJSON()) }
        // try! runStructureDefinition1(existing.asJSON())
        
        // second time updating it will overwrite values of child resources/elements, but maintain keys
        // TODO: Find a way to actually test this instead of breakpoints and eyeballing it.
        existing = realm.object(ofType: FireKit.StructureDefinition.self, forPrimaryKey: newInst.pk)!
        // try! realm.write{ _ = existing.populate(from: instance.asJSON()) }
        // try! runStructureDefinition1(existing.asJSON())
