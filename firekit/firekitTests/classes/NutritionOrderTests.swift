...
class NutritionOrderTests: XCTestCase, RealmPersistenceTesting {    
    ...
    func testNutritionOrder1Copying() {
        do {
            ...
            XCTAssertTrue(false, "Must copy and test NutritionOrder successfully, but threw: \(error)")
        }
    }

    func testNutritionOrder1Populatability() {
        do {
            let instance = try runNutritionOrder1()
            let copy = FireKit.NutritionOrder()
    ...
    func testNutritionOrderRealm1(_ instance: FireKit.NutritionOrder) {
        ...
        let existing = realm.object(ofType: FireKit.NutritionOrder.self, forPrimaryKey: newInst.pk)!
    ...
    func testNutritionOrder2Copying() {
        do {
    ...
    func testNutritionOrder2Populatability() {
        do {
            let instance = try runNutritionOrder2()
            let copy = FireKit.NutritionOrder()
            copy.populate(from: instance)
    ...
    func testNutritionOrder3Copying() {
        do {
    ...
    func testNutritionOrder3Populatability() {
        do {
            let instance = try runNutritionOrder3()
            let copy = FireKit.NutritionOrder()
            copy.populate(from: instance)
    ...
    func testNutritionOrder4Copying() {
        do {
    ...
    func testNutritionOrder4Populatability() {
        do {
            let instance = try runNutritionOrder4()
            let copy = FireKit.NutritionOrder()
            copy.populate(from: instance)
    ...
    func testNutritionOrder5Copying() {
        do {
    ...
    func testNutritionOrder5Populatability() {
        do {
            let instance = try runNutritionOrder5()
            let copy = FireKit.NutritionOrder()
            copy.populate(from: instance)
    ...
    func testNutritionOrder6Copying() {
        do {
    ...
    func testNutritionOrder6Populatability() {
        do {
            let instance = try runNutritionOrder6()
            let copy = FireKit.NutritionOrder()
            copy.populate(from: instance)
    ...
    func testNutritionOrder7Copying() {
        do {
    ...
    func testNutritionOrder7Populatability() {
        do {
            let instance = try runNutritionOrder7()
            let copy = FireKit.NutritionOrder()
            copy.populate(from: instance)
    ...
    func testNutritionOrder8Copying() {
        do {
    ...
    func testNutritionOrder8Populatability() {
        do {
            let instance = try runNutritionOrder8()
            let copy = FireKit.NutritionOrder()
            copy.populate(from: instance)
    ...
    func testNutritionOrder9Copying() {
        do {
    ...
    func testNutritionOrder9Populatability() {
        do {
            let instance = try runNutritionOrder9()
            let copy = FireKit.NutritionOrder()
            copy.populate(from: instance)
    ...
    func testNutritionOrder10Copying() {
        do {
    ...
    func testNutritionOrder10Populatability() {
        do {
            let instance = try runNutritionOrder10()
            let copy = FireKit.NutritionOrder()
            copy.populate(from: instance)
