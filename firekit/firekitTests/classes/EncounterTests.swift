...
class EncounterTests: XCTestCase, RealmPersistenceTesting {    
    ...
    func testEncounter1Copying() {
        do {
            ...
            XCTAssertTrue(false, "Must copy and test Encounter successfully, but threw: \(error)")
        }
    }

    func testEncounter1Populatability() {
        do {
            let instance = try runEncounter1()
            let copy = FireKit.Encounter()
    ...
    func testEncounterRealm1(_ instance: FireKit.Encounter) {
        ...
        let existing = realm.object(ofType: FireKit.Encounter.self, forPrimaryKey: newInst.pk)!
    ...
    func testEncounter2Populatability() {
        do {
            let instance = try runEncounter2()
            let copy = FireKit.Encounter()
            copy.populate(from: instance)
    ...
    func testEncounter3Populatability() {
        do {
            let instance = try runEncounter3()
            let copy = FireKit.Encounter()
            copy.populate(from: instance)
    ...
    func testEncounter4Populatability() {
        do {
            let instance = try runEncounter4()
            let copy = FireKit.Encounter()
            copy.populate(from: instance)
    ...
    func testEncounter5Populatability() {
        do {
            let instance = try runEncounter5()
            let copy = FireKit.Encounter()
            copy.populate(from: instance)
    ...
    func testEncounter6Populatability() {
        do {
            let instance = try runEncounter6()
            let copy = FireKit.Encounter()
            copy.populate(from: instance)
    ...
    func testEncounter7Populatability() {
        do {
            let instance = try runEncounter7()
            let copy = FireKit.Encounter()
            copy.populate(from: instance)
    ...
    func testEncounter8Populatability() {
        do {
            let instance = try runEncounter8()
            let copy = FireKit.Encounter()
            copy.populate(from: instance)
    ...
    func testEncounter9Populatability() {
        do {
            let instance = try runEncounter9()
            let copy = FireKit.Encounter()
            copy.populate(from: instance)
