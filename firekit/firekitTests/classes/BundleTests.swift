...
class BundleTests: XCTestCase, RealmPersistenceTesting {    
    ...
    func testBundle1RealmPK() {        
        do {
            let instance: FireKit.Bundle = try runBundle1()
            let copy = (instance.copy() as! FireKit.Bundle)
	...
	func testBundleRealm1(instance: FireKit.Bundle) {
        ...
        try! runBundle1(realm.objects(FireKit.Bundle.self).first!.asJSON())
        ...
        existing = realm.object(ofType: FireKit.Bundle.self, forPrimaryKey: newInst.pk)!
        try! realm.write{ _ = existing.populate(from: instance.asJSON()) }
        try! runBundle1(existing.asJSON())
    ...
    func testBundle2RealmPK() {        
        do {
            let instance: FireKit.Bundle = try runBundle2()
            let copy = (instance.copy() as! FireKit.Bundle)
	...
	func testBundleRealm2(instance: FireKit.Bundle) {
        ...
        try! runBundle2(realm.objects(FireKit.Bundle.self).first!.asJSON())
    ...
    func testBundle3RealmPK() {        
        do {
            let instance: FireKit.Bundle = try runBundle3()
            let copy = (instance.copy() as! FireKit.Bundle)
	...
	func testBundleRealm3(instance: FireKit.Bundle) {
        ...
        try! runBundle3(realm.objects(FireKit.Bundle.self).first!.asJSON())
    ...
    func testBundle4RealmPK() {        
        do {
            let instance: FireKit.Bundle = try runBundle4()
            let copy = (instance.copy() as! FireKit.Bundle)
	...
	func testBundleRealm4(instance: FireKit.Bundle) {
        ...
        try! runBundle4(realm.objects(FireKit.Bundle.self).first!.asJSON())
    ...
    func testBundle5RealmPK() {        
        do {
            let instance: FireKit.Bundle = try runBundle5()
            let copy = (instance.copy() as! FireKit.Bundle)
	...
	func testBundleRealm5(instance: FireKit.Bundle) {
        ...
        try! runBundle5(realm.objects(FireKit.Bundle.self).first!.asJSON())
    ...
    func testBundle6RealmPK() {        
        do {
            let instance: FireKit.Bundle = try runBundle6()
            let copy = (instance.copy() as! FireKit.Bundle)
	...
	func testBundleRealm6(instance: FireKit.Bundle) {
        ...
        try! runBundle6(realm.objects(FireKit.Bundle.self).first!.asJSON())
    ...
    func testBundle7RealmPK() {        
        do {
            let instance: FireKit.Bundle = try runBundle7()
            let copy = (instance.copy() as! FireKit.Bundle)
	...
	func testBundleRealm7(instance: FireKit.Bundle) {
        ...
        try! runBundle7(realm.objects(FireKit.Bundle.self).first!.asJSON())
    ...
    func testBundle8RealmPK() {        
        do {
            let instance: FireKit.Bundle = try runBundle8()
            let copy = (instance.copy() as! FireKit.Bundle)
	...
	func testBundleRealm8(instance: FireKit.Bundle) {
        ...
        try! runBundle8(realm.objects(FireKit.Bundle.self).first!.asJSON())
