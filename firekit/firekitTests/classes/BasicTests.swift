...
class BasicTests: XCTestCase, RealmPersistenceTesting {    
    ...
    func testBasic1NillingPopulatability() {
        do {
            let instance = try runBasic1()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.Basic()) }
        } catch let error {
            XCTAssertTrue(false, "Must populate a test Basic successfully, but threw: \(error)")
        }
    }
    ...
    func testBasic2NillingPopulatability() {
        do {
            let instance = try runBasic2()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.Basic()) }
    ...
    func testBasic3NillingPopulatability() {
        do {
            let instance = try runBasic3()
            try! realm.write { realm.add(instance) }
            try! realm.write { instance.populate(from: FireKit.Basic()) }
