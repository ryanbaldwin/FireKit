...
//  SwiftFHIR
//
//  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/DeviceMetric) on 2017-11-13.
...
open class DeviceMetric: DomainResource {
    ...
    public override func populate(from other: Any) {
        ...
        while self.calibration.count > o.calibration.count {
            let objectToRemove = self.calibration.last!
            self.calibration.removeLast()
