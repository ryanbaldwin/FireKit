...
//  SwiftFHIR
//
//  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/VisionPrescription) on 2017-11-13.
...
open class VisionPrescription: DomainResource {
    ...
    public override func populate(from other: Any) {
        ...
        while self.dispense.count > o.dispense.count {
            let objectToRemove = self.dispense.last!
            self.dispense.removeLast()
