...
//  SwiftFHIR
//
//  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/Goal) on 2017-11-13.
...
open class Goal: DomainResource {
    ...
    public override func populate(from other: Any) {
        ...
        while self.outcome.count > o.outcome.count {
            let objectToRemove = self.outcome.last!
            self.outcome.removeLast()
            try! (objectToRemove as? CascadeDeletable)?.cascadeDelete() ?? realm?.delete(objectToRemove)
        }
