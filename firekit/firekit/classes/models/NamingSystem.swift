...
//  SwiftFHIR
//
//  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/NamingSystem) on 2017-11-13.
...
open class NamingSystem: DomainResource {
    ...
    public override func populate(from other: Any) {
        ...
        while self.uniqueId.count > o.uniqueId.count {
            let objectToRemove = self.uniqueId.last!
            self.uniqueId.removeLast()
            try! (objectToRemove as? CascadeDeletable)?.cascadeDelete() ?? realm?.delete(objectToRemove)
        }
        usage = o.usage
