...
class PractitionerTests: XCTestCase, RealmPersistenceTesting {    
	...
	func instantiateFrom(filename: String) throws -> RealmSwiftFHIR.Practitioner {
		return instantiateFrom(json: try readJSONFile(filename))
	}
	
	func instantiateFrom(json: FHIRJSON) -> RealmSwiftFHIR.Practitioner {
		let instance = RealmSwiftFHIR.Practitioner(json: json)
	...
	@discardableResult
	func runPractitioner1(_ json: FHIRJSON? = nil) throws -> RealmSwiftFHIR.Practitioner {
	...
	@discardableResult
	func runPractitioner2(_ json: FHIRJSON? = nil) throws -> RealmSwiftFHIR.Practitioner {
	...
	@discardableResult
	func runPractitioner3(_ json: FHIRJSON? = nil) throws -> RealmSwiftFHIR.Practitioner {
	...
	@discardableResult
	func runPractitioner4(_ json: FHIRJSON? = nil) throws -> RealmSwiftFHIR.Practitioner {
	...
	@discardableResult
	func runPractitioner5(_ json: FHIRJSON? = nil) throws -> RealmSwiftFHIR.Practitioner {
	...
	@discardableResult
	func runPractitioner6(_ json: FHIRJSON? = nil) throws -> RealmSwiftFHIR.Practitioner {
	...
	@discardableResult
	func runPractitioner7(_ json: FHIRJSON? = nil) throws -> RealmSwiftFHIR.Practitioner {
	...
	@discardableResult
	func runPractitioner8(_ json: FHIRJSON? = nil) throws -> RealmSwiftFHIR.Practitioner {
	...
	@discardableResult
	func runPractitioner9(_ json: FHIRJSON? = nil) throws -> RealmSwiftFHIR.Practitioner {
	...
	@discardableResult
	func runPractitioner10(_ json: FHIRJSON? = nil) throws -> RealmSwiftFHIR.Practitioner {
