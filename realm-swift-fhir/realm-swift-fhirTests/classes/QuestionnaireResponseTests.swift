...
class QuestionnaireResponseTests: XCTestCase, RealmPersistenceTesting {    
	...
	func instantiateFrom(filename: String) throws -> RealmSwiftFHIR.QuestionnaireResponse {
		return instantiateFrom(json: try readJSONFile(filename))
	}
	
	func instantiateFrom(json: FHIRJSON) -> RealmSwiftFHIR.QuestionnaireResponse {
		let instance = RealmSwiftFHIR.QuestionnaireResponse(json: json)
		XCTAssertNotNil(instance, "Must have instantiated a test instance")
		return instance
	}
	
	func testQuestionnaireResponse1() {		
		var instance: RealmSwiftFHIR.QuestionnaireResponse?
		do {
			instance = try runQuestionnaireResponse1()
			try runQuestionnaireResponse1(instance!.asJSON()) 		
			let copy = instance!.copy() as? RealmSwiftFHIR.QuestionnaireResponse
		...
		testQuestionnaireResponseRealm1(instance: instance!)
	}

    func testQuestionnaireResponse1RealmPK() {        
        do {
            let instance: RealmSwiftFHIR.QuestionnaireResponse = try runQuestionnaireResponse1()
            let copy = (instance.copy() as! RealmSwiftFHIR.QuestionnaireResponse)
	...
	func testQuestionnaireResponseRealm1(instance: RealmSwiftFHIR.QuestionnaireResponse) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runQuestionnaireResponse1(realm.objects(RealmSwiftFHIR.QuestionnaireResponse.self).first!.asJSON())
        
        // ensure we can update it.
        try! realm.write { instance.implicitRules = "Rule #1" }
        XCTAssertEqual(1, realm.objects(RealmSwiftFHIR.QuestionnaireResponse.self).count)
        XCTAssertEqual("Rule #1", realm.objects(RealmSwiftFHIR.QuestionnaireResponse.self).first!.implicitRules)
        
        // create a new instance with default key, save it, then populate it from instance JSON. 
        // PK should persist and not be overwritten.
        let newInst = RealmSwiftFHIR.QuestionnaireResponse()
        try! realm.write { realm.add(newInst) }
        
        // first time updating it should inflate children resources/elements which don't exist
        var existing = realm.object(ofType: RealmSwiftFHIR.QuestionnaireResponse.self, forPrimaryKey: newInst.pk)!
        try! realm.write{ _ = existing.populate(from: instance.asJSON()) }
        try! runQuestionnaireResponse1(existing.asJSON())
        
        // second time updating it will overwrite values of child resources/elements, but maintain keys
        // TODO: Find a way to actually test this instead of breakpoints and eyeballing it.
        existing = realm.object(ofType: RealmSwiftFHIR.QuestionnaireResponse.self, forPrimaryKey: newInst.pk)!
        try! realm.write{ _ = existing.populate(from: instance.asJSON()) }
        try! runQuestionnaireResponse1(existing.asJSON())
        ...
        XCTAssertEqual(0, realm.objects(RealmSwiftFHIR.QuestionnaireResponse.self).count)
	}
	
	@discardableResult
	func runQuestionnaireResponse1(_ json: FHIRJSON? = nil) throws -> RealmSwiftFHIR.QuestionnaireResponse {
	...
	func testQuestionnaireResponse2() {		
		...
		testQuestionnaireResponseRealm2(instance: instance!)
	}

    func testQuestionnaireResponse2RealmPK() {        
        do {
            let instance: RealmSwiftFHIR.QuestionnaireResponse = try runQuestionnaireResponse2()
            let copy = (instance.copy() as! RealmSwiftFHIR.QuestionnaireResponse)
	...
	func testQuestionnaireResponseRealm2(instance: RealmSwiftFHIR.QuestionnaireResponse) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runQuestionnaireResponse2(realm.objects(RealmSwiftFHIR.QuestionnaireResponse.self).first!.asJSON())
	...
	@discardableResult
	func runQuestionnaireResponse2(_ json: FHIRJSON? = nil) throws -> RealmSwiftFHIR.QuestionnaireResponse {
	...
	func testQuestionnaireResponse3() {		
		...
		testQuestionnaireResponseRealm3(instance: instance!)
	}

    func testQuestionnaireResponse3RealmPK() {        
        do {
            let instance: RealmSwiftFHIR.QuestionnaireResponse = try runQuestionnaireResponse3()
            let copy = (instance.copy() as! RealmSwiftFHIR.QuestionnaireResponse)
	...
	func testQuestionnaireResponseRealm3(instance: RealmSwiftFHIR.QuestionnaireResponse) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runQuestionnaireResponse3(realm.objects(RealmSwiftFHIR.QuestionnaireResponse.self).first!.asJSON())
	...
	@discardableResult
	func runQuestionnaireResponse3(_ json: FHIRJSON? = nil) throws -> RealmSwiftFHIR.QuestionnaireResponse {
	...
	func testQuestionnaireResponse4() {		
		...
		testQuestionnaireResponseRealm4(instance: instance!)
	}

    func testQuestionnaireResponse4RealmPK() {        
        do {
            let instance: RealmSwiftFHIR.QuestionnaireResponse = try runQuestionnaireResponse4()
            let copy = (instance.copy() as! RealmSwiftFHIR.QuestionnaireResponse)
	...
	func testQuestionnaireResponseRealm4(instance: RealmSwiftFHIR.QuestionnaireResponse) {
		// ensure we can write the instance, then fetch it, serialize it to JSON, then deserialize that JSON 
        // and ensure it passes the all the same tests.
		try! realm.write {
                realm.add(instance)
            }
        try! runQuestionnaireResponse4(realm.objects(RealmSwiftFHIR.QuestionnaireResponse.self).first!.asJSON())
	...
	@discardableResult
	func runQuestionnaireResponse4(_ json: FHIRJSON? = nil) throws -> RealmSwiftFHIR.QuestionnaireResponse {
