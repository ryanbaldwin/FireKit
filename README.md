...
2. Add `github "ryanbaldwin/FireKit" == 2.40.03` to the your `Cartfile` (see [Versioning](#versioning) for more info)
...
Current of `FireKit` is `v2.40.03` and is based on the [FHIR DSTU2 spec](https://www.hl7.org/fhir/DSTU2/).
